...
class FillPermissionsForDependencia extends Migration
{
    /**
    ...
    /**
     * FillPermissionsForDependencia constructor.
     */
    public function __construct()
    {
        ...
        $permissions = collect([
            'admin.dependencia',
            'admin.dependencia.index',
            'admin.dependencia.create',
            'admin.dependencia.show',
            'admin.dependencia.edit',
            'admin.dependencia.delete',
            'admin.dependencia.bulk-delete',
        ]);
